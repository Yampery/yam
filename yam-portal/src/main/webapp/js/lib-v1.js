...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://127.0.0.1:8089/rest/itemcat/list?callback=category.getDataService", // ajax跨域请求
		// URL_Serv: "http://localhost:8090/category.json",// 本地请求json
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	//直接使用ajax请求json数据--本地请求的是静态json数据
