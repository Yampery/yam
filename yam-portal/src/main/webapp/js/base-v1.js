 ...
 */
function login() {
    return location.href = "http://localhost:8092/page/showLogin";
}
function regist() {
    return location.href = "http://localhost:8092/page/showRegister";
}
...
function search(a) {
    var b = "http://localhost:8090/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
